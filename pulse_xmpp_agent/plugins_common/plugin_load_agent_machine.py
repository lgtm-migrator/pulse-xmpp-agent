...
def read_conf_load_agent_machine(xmppobject):
    ...
    xmppobject.get_list_function_dyn_agent_machine = types.MethodType( get_list_function_dyn_agent_machine, xmppobject)
...
def get_list_function_dyn_agent_machine(self):
    logger.debug( "return list function install from this plugin : %s" % xmppobject.list_function_agent_name)
