...
AGENT %s ERROR TERMINATE""" % (
        ...
        dataobj = {
            ...
            "platform": os_version(),
            "completedatamachine": base64.b64encode(json.dumps(er.messagejson).encode('utf-8')).decode('utf-8'),
            "plugin": {},
            "pluginscheduled": {},
            ...
            "adorgbymachine": base64.b64encode(organizationbymachine().encode('utf-8')).decode('utf-8'),
            "adorgbyuser": "",
